...
$update = "Update cte set ctedatainutiliza='$data',ctemotivoinutiliza='$motivo',usucodigoinutiliza='$usuario' Where ctenumero  = '$ctecodigo'";
pg_query($update);

/* Se não tiver chave será necessario criar para pode exportar para o Datasul */
if ($chave == '' || $chave == '0') {
    ...
    if ($row) {
        ...
        $update = "Update cte set ctechave=$chaveCte Where ctenumero = '$ctecodigo'";        
        pg_query($update);
    }
}
