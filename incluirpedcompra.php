...
<html>
    <head>
        ...
        <!-- Title Page-->
        <title>Inclusão de Pedidos de Compra</title>
    ...
    <body onLoad="limpa_form(<?php echo $pcnumero ?>,<?php echo $valor2 ?>,<?php echo MAX_NOVO ?>)">
                        ...
                        <form name="formulario" method="POST">
                                ...
                                <div class="col-3">
                                    <div class="input-group-small m-r-45">
                                        ...
                                        <div class="input-group-small-icon">
                                            <input class="input--style-4" name="pcnumero" type="text" id="pcnumero" size="10" style="BACKGROUND-COLOR: #b3c6ff; COLOR: #660000; FONT-WEIGHT: bold;" disabled="">
                            ...
                            <div class="row row-space">
                                <div class="col-2 centraliza">
                                    <button class="btn-small btn--radius-2 btn--blue" name="button" type="button" id="buttonx" onClick="incluir()">Incluir</button>
                                </div> 
                                <div class="col-2 centraliza">
                                    <button class="btn-small btn--radius-2 btn--green" name="button2" type="button" id="button2" onClick="entrega()">Entrega</button>
                                </div>
                            </div>   
                            ...
                            <div class="row row-space">
                                <div class="col-2 centraliza">
                                    <button class="btn btn--radius-2 btn--blue" name="button2" type="button" id="botao" onClick="valida_form()">Incluir</button>
                                </div> 
                                <div class="col-2 centraliza">
                                    <button class="btn btn--radius-2 btn--red" type="button" id="botao2" onClick="limpa_form(0)">Limpar</button>
                                </div>
        ...
        <script src="js/incluirpedcompra.js"></script>
