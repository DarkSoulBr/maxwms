...
<script src="js/infonfe.js"></script>
  ...
  <tr>
	<td>
		<table width="100%"  height="20" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
		  <tr>
			<td colspan="4" >
			<div align="center"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><strong>Nota Fiscal Eletrônica</strong></font></div>
			</td>
		  </tr>
		</table>
          ...
          <table width="100%" height="80" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">            
			...
			<tr bgcolor="#CCCCCC">
				<td>&nbsp;</td>
				<td valign="middle"><div align="left">Chave:</div></td>
				<td colspan="2" valign="middle"><input id="servico" type="text" name="servico" size="46" onKeyPress="maiusculo()" onBlur="convertField(this)" maxlength="50"></td>
				<input name="hidden" type="hidden" id="codservico" value="">
			</tr>
			
			<tr bgcolor="#CCCCCC">
				<td>&nbsp;</td>
				<td valign="middle"><div align="left">PIN:</div></td>
				<td colspan="2" valign="middle"><input type="text" name="valor" id="valor" maxlength="10" size="18" onKeyPress="maiusculo()" onBlur="convertField(this)" maxlength="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="incluir" id="incluir" value="Incluir" onclick="enviar();"></td>				
			</tr>
