...
function enviar()
{
    ...
    {	
		ajax2.open("POST", "clientecteinsere.php", true);
	...
	{			
		...
		new ajax ('clientectealtera.php?fornguerra=' + document.getElementById('fornguerra').value +
...
function dadospesquisa3(valor)
{
	...
	if(ajax2)
	{
	    ...
	    ajax2.open("POST", "clientectepesquisa3.php", true);
		ajax2.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
