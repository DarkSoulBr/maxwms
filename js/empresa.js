...
function enviar()
{
    ...
    {	
		ajax2.open("POST", "empresainsere.php", true);
        ...
        ajax2.send(params);	
		//window.open('empresainsere.php?' + params , '_blank');

	}
	else if($("acao").value=="alterar")
	{			
		//window.open ('clientealtera.php?fornguerra=' + document.getElementById('fornguerra').value +
		new ajax ('empresaaltera.php?fornguerra=' + document.getElementById('fornguerra').value +
...
function dadospesquisa2(valor)
{
	...
	if(ajax2)
	{
		ajax2.open("POST", "empresapesquisa2.php", true);
		ajax2.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
function dadospesquisa3(valor)
{
	...
	if(ajax2)
	{
	    ...
	    ajax2.open("POST", "empresapesquisa3.php", true);
		ajax2.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
