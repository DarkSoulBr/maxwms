...
function load_grid_estoque3(){
      new ajax ('cadastroconsultasetor.php', {onComplete: imprime_estoque3});
}
...
function imprelatorioexexcel(){
	...
	if(invdata==''){
		...
		if (document.getElementById("radio1").checked==true){	
			window.open('relatoriogeracontagemcoletorexcel.php?contagem='+contagem+'&coletor='+contagem2+'&invdata='+invdata, 'Report', 'status=yes, scrollbars=yes, location=no, toolbar=no, directories=no, resizable=no, fullscreen=yes');						
		}
		else {
			...
			if(estoque==''){
				...
				window.open('relatoriogeracontagemcoletorsetorexcel.php?contagem='+contagem+'&coletor='+contagem2+'&invdata='+invdata+'&setor='+estoque, 'Report', 'status=yes, scrollbars=yes, location=no, toolbar=no, directories=no, resizable=no, fullscreen=yes');				
			}	
		}	
	}	
}
