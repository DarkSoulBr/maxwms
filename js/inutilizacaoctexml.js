function env(usuario){
	...
	if ($("botao3").value=="Confirma"){
		...
		if (erro==0){
			//window.open ('inutilizacaoctexmlconfirma.php?motivo=' + document.getElementById('motivo').value 
			new ajax ('inutilizacaoctexmlconfirma.php?motivo=' + document.getElementById('motivo').value 			
			+ '&usuario=' + usuario
...
function limpa_form(){
	...
	window.open('inutilizacaoctexml.php' ,'_self');
