function importarPedido()
{
	...
	novaJanela("telauploadarquivonfe.php","UPLOAD DE ARQUIVOS")
...
function importarPedidoOK()
{
	...
	window.open('imprimepdfnfe.php?usuario='+usuario, 'Report', 'status=yes, scrollbars=yes, location=no, toolbar=no, directories=no, resizable=no, fullscreen=yes');
