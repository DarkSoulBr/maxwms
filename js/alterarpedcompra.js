...
//Limpar
        ...
        $("acao").value = "inserir";
        document.getElementById("botao").innerHTML = "Incluir";
        ...
        //Desabilita todos os botões de manutenção e Habilita a pesquisa
        ...
        document.getElementById('pcnumero').disabled = false;
...
function enviar(opc) {
    ...
    if ($("acao").value == "inserir") {
        ...
        ajax2.onreadystatechange = function () {
            ...
            {
                if (ajax2.responseXML) {
                    processXMLaltera(ajax2.responseXML);
                }
            }
        }
        var params = 'pcnumero=' + document.getElementById('pcnumero').value
...
function processXMLaltera(obj) {
    ...
    if (dataArray.length > 0) {
        ...
        for (var i = 0; i < dataArray.length; i++) {
            ...
            alert("Pedido " + pedidocriado + " alterado com sucesso!");
    ...
    window.open('alterarpedcompra.php', '_self');
    ...
    if (dataArray.length > 0)
    {
        ...
        for (var i = 0; i < dataArray.length; i++)
        {
            ...
            if (pcempresa == 2) {
                ...
                $("acao").value = "alterar";
                document.getElementById("botao").innerHTML = "Alterar";
...
function load_grid(pcnumero) {
    ...
    new ajax('pedcomprapesquisaitensnew.php?pcnumero=' + pcnumero, {onLoading: carregando, onComplete: imprime1});
}
            ...
            for (j = 0; j < itens.length; j++) {
                ...
                if (itens[j].firstChild == null) {
                    ...
                    if (j == 0) {
                        ...
                        tabela += "<div class='cell-max' data-title='Codigo'>" + vet[i][j] + "</div>"
                    } else if (j == 1) {
                        vet[i][j] = itens[j].firstChild.data;
                        tabela += "<div class='cell-max' data-title='Produto'>" + vet[i][j] + "</div>"
                    } else if (j == 2) {
                        vet[i][j] = itens[j].firstChild.data;
                        cod = 'a' + i;
                        k = 2;
...
function imprime1naousamais(request) {
...
function pesquisacodigo(valor) {
    ...
    if (ajax2) {
        /*
         if (document.getElementById("radioa4").checked == true) {
         ajax2.open("POST", "pedcomprapesquisacodigovit.php", true);
         } else {
         ajax2.open("POST", "pedcomprapesquisacodigo.php", true);
         }
         */
...
function pesquisaprodutos(valor) {
    if (valor != "") {
        ...
        if (ajax2) {
            ...
            /*
             if (document.getElementById("radioa4").checked == true) {
             ajax2.open("POST", "pedcomprapesquisaprodutovit.php", true);
             } else {
             ajax2.open("POST", "pedcomprapesquisaproduto.php", true);
             }
             */
            ajax2.open("POST", "pedcomprapesquisacusto.php", true);
...
function pesquisacod(valor) {
    ...
    if (ajax2) {
        /*
         if (document.getElementById("radioa4").checked == true) {
         ajax2.open("POST", "pedcomprapesquisacodvit.php", true);
         } else {
         ajax2.open("POST", "pedcomprapesquisacod.php", true);
         }
         */
        ajax2.open("POST", "pedcomprapesquisacusto.php", true);
...
function verifica() {
    if (confirm("Confirma a exlusão do pedido " + document.getElementById('pcnumero').value + " ?")) {
        verificabaixa();
        //excluir();
...
function verificabaixa() {
    ...
    var numped = document.getElementById('pcnumero').value;
    new ajax('pedcompraverificabaixa.php?pedido=' + numped, {onComplete: imprime_baixa});

    //window.open('pedcompraverificabaixa.php?pedido='+numped, '_blank');

}



function imprime_baixa(request) {
    ...
    if (temnota == 1) {
        alert('Favor cancelar as baixas antes de excluir o pedido!');
    } else {
        excluir()
    }
...
function excluir() {
    window.open('pedcompraexcluinovo.php?pcnumero=' + document.getElementById('pcnumero').value, '_self');
}
...
function sugestao2(pcnumero) {

    new ajax('pedcomprapesquisaitens2.php?pcnumero=' + pcnumero, {onLoading: carregando, onComplete: imprime2});
...
function imprime2(request) {
    ...
    if (cabecalho != null)
    {
        ...
        tabela += "<td class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><b>Produto</b></td>";
        tabela += "<td class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><b>Quantidade</b></td>";
        tabela += "<td class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><b>Depósito</b></td>";
        tabela += "<td class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><b>Loja Nova</b></td>";
        tabela += "<td class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><b>Loja</b></td>";
        tabela += "<td class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><b>Loja Nova</b></td>";
        tabela += "<td class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><b>Loja</b></td>";
        ...
        for (i = 0; i < registros.length; i++) {
            ...
            for (j = 0; j < itens.length; j++) {
                ...
                if (j < 2) {
                    ...
                    var sald = Math.round(itens[j].firstChild.data) - Math.round(itens[10].firstChild.data); //saldo - baixa
                    vet[i][j] = sald;
                    //vet[i][j]=itens[j].firstChild.data;
                    tabela += "<td class='borda'>" + vet[i][j] + "</td>";
                } else if (j == 3) {
                    ...
                    k = 6;
                    val = vet[i][6];
                    tabela += "<td class='borda' style='cursor: pointer'><input type='text' id='" + cod + "' name='" + cod + "' value='" + val + "' size='8' onBlur='convertField3(this);editar2(" + i + "," + k + ",this.value" + ");' onKeyPress='return Tecla(event);' ></td>";
                } else if (j == 7) {
                    vet[i][j] = itens[j].firstChild.data;
                    cod = 'f' + i;
                    k = 7;
...
function confirma2(valor2) {

    if (confirm("Confirma a sugestão de transferencia?\n\t")) {
        ...
        for (var i = 0; i < 700; i++) {
            if (vet[i][0] != 0) {
                ...
                var quant = Math.round(vet[i][6]) + Math.round(vet[i][7]);
                if (quant > vet[i][2]) {
                    alert('Verifique as quantidades!');
                    return;
                }
        ...
        for (var i = 0; i < 700; i++) {
            if (vet[i][0] != 0) {
                ...
                campovet1 = campovet1 + '&a[]=' + vet[i][8];
                campovet2 = campovet2 + '&b[]=' + vet[i][6];
                campovet3 = campovet3 + '&c[]=' + vet[i][7];
        ...
        //window.open ('pedcompraaltera2.php?pcnumero=' + document.getElementById('pcnumero').value
        new ajax('pedcompraaltera2.php?pcnumero=' + document.getElementById('pcnumero').value
                + '' + campovet1
                + '' + campovet2
                + '' + campovet3
                , {onComplete: voltar(document.getElementById('pcnumero').value, valor2)});
        //, '_blank');
...
function voltar(valor, valor2) {
    if (valor2 == 1) {
        window.open('pedcompra.php?pcnumero=' + valor + '&valor2=1', '_self');
    } else {
        window.open('pedcompra.php?pcnumero=' + valor, '_self');
    }
}
...
function importarPedidox()
{

    $("importaPedido").disabled = true;
    //$("importaPedido2").disabled = true;

    var arquivo = 'arquivos/modelos/compra.xls';



    $a('#dialog').attr('title', 'ABRIR PEDIDO');
    $a('#dialog').html('<p>IMPORTAR PEDIDO NO FORMATO XLS (EXCEL).</p>' +
    ...
    $a('#swfupload-control').upload(
            {
                fileTypesDescription: "Arquivo do Excel",
                fileTypes: "*.xls",
                fileSizeLimit: "10240",
                //uploadUrl: "modulos/vendaAtacado/pedidos/manutencao/controller/uploadCompraExcel.php",
                uploadUrl: "uploadCompraExcel.php",
                ...
                uploadSuccess: function (event, file, data)
                {
                    ...
                    /*
                     var tpp = pedido.tipoPedido.sigla + ' ' + pedido.tipoPedido.descricao;
                     var nome_tipopedido = pedido.tipoPedido.codigo;
                     
                     nome_tipopedidox = pedido.tipoPedido.codigo;
