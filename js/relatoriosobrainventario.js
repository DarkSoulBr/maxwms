...
function load_grid()
{
	...
	window.open('relatoriogerasobrainventario.php?estoque='+estoque+grupo+subgrupo+'&nome='+nome+'&invdata='+invdata, 'Report', 'status=yes, scrollbars=yes, location=no, toolbar=no, directories=no, resizable=no, fullscreen=yes');
}
