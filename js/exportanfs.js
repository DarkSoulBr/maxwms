...
function imprimirconsulta()
{
    ...
    if (erro == '0') {
        window.open('exportacaonfs.php?data=' + dataini + '&todos=' + todos + produto, '_blank');
    }
}
...
function load_grid_produtos()
{
    ...
    new ajax('cadastroconsultasaidasgeral.php?nome=' + consultapro + '&opcao=' + opcaochecada, {onLoading: carregando, onComplete: imprime_produto});
