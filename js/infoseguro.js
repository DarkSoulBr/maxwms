...
function inicia(usucodigo){
	...
	dadospesquisaresponsavel(0);
	
}

function dadospesquisaresponsavel(valor)
{
  ...
  if(ajax2) {
     ...
     ajax2.open("POST", "ctepesquisaresponsavel.php", true);
...
function imprime_serv(request){
	...
	if(cabecalho!=null)
	{
		...
		tabela+="<td colspan='1' class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><font color='#ffffff'><b>Seguradora</b></font></td>"	
		tabela+="<td colspan='1' class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><font color='#ffffff'><b>Apolice</b></font></td>"	
		tabela+="<td colspan='1' class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><font color='#ffffff'><b>Averbacao</b></font></td>"	
...
function enviar(){
	...
	var averbacao = document.getElementById('averbacao').value;
	...
	if(servico=='')
	{
		alert("Digite o nome da Seguradora!");		
		erro = 1;
	}
	...
	if(erro=='0'){	
		...
		new ajax ('infoseguroinsere.php?usucodigo='+ vusuario		
...
function apagar(codigo){
    new ajax ('infoseguroapaga.php?codigo=' + codigo
        , {onLoading: carregando, onComplete: load_grid_serv});
}

function editar(codigo){

	new ajax ('infosegurocarrega.php?parametro='+ codigo 
	...
	if(cabecalho!=null)
	{
		...
		for(i=0;i<registros.length;i++){
			...
			if(itens[4].firstChild.data=='_'){
				...
				$("apolice").value=itens[4].firstChild.data;
			}
			if(itens[5].firstChild.data=='_'){
				$("averbacao").value='';	
			}
			else {
				$("averbacao").value=itens[5].firstChild.data;
			}	
