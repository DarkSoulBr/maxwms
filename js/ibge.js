...
function enviar(){
	...
	if($("acao").value=="inserir"){
		...
		new ajax ('ibgeinsere.php?cidnome=' + document.getElementById('cidnome').value +
                 '&estcodigo=' + document.forms[0].listestados.options[document.forms[0].listestados.selectedIndex].text +
		...
		new ajax ('ibgealtera.php?cidcodigo=' + document.getElementById('cidcodigo').value + '&cidnome=' + document.getElementById('cidnome').value + '&estcodigo=' + document.forms[0].listestados.options[document.forms[0].listestados.selectedIndex].text + '&cep=' + document.getElementById('cep').value + '&cep2=' + document.getElementById('cep2').value, {});		
...
function apagar(cidcodigo){
	new ajax ('ibgeapaga.php?cidcodigo=' + cidcodigo, {});	
	limpa_form();
}
...
function dadospesquisa(valor) {
	  ...
	  if(ajax2) {
	     ...
	     ajax2.open("POST", "ibgepesquisa.php", true);
...
function dadospesquisa2(valor) {
	  ...
	  if(ajax2) {
		 ...
		 ajax2.open("POST", "ibgepesquisa2.php", true);
		 ajax2.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
function dadospesquisa3(valor) {
	  ...
	  if(ajax2) {
	     ...
	     ajax2.open("POST", "ibgepesquisa3.php", true);
		 ajax2.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
