function importarPedido()
{
	...
	novaJanela("telauploadarquivocte.php","UPLOAD DE ARQUIVOS")
...
function importarPedidoOK()
{
	...
	window.open('imprimepdfcte.php?usuario='+usuario, 'Report', 'status=yes, scrollbars=yes, location=no, toolbar=no, directories=no, resizable=no, fullscreen=yes');
