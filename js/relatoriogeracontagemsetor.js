...
function load_grid_estoque2(){
      new ajax ('cadastroconsultaset.php', {onComplete: imprime_estoque2});
}
...
function imprime_estoque2(request)
{
	var xmldoc=request.responseXML;
  	...
  	var tabelax="<span class=\"custom-dropdown\"><select id=\"estoque2\" name=\"estoque2\" size=\"1\"><option value=\"0\">-- Escolha um Setor --</option>";
...
function load_grid_estoque3(){
      new ajax ('cadastroconsultacol.php', {onComplete: imprime_estoque3});
}
...
function imprelatorioexexcel(){
	...
	if(invdata==''){
		...
		if (document.getElementById("radio1").checked==true){	
			window.open('relatoriogeracontagemsetexcel.php?contagem='+contagem+'&setor='+contagem2+'&invdata='+invdata, 'Report', 'status=yes, scrollbars=yes, location=no, toolbar=no, directories=no, resizable=no, fullscreen=yes');						
		}
		else {
			...
			if(estoque==''){
				...
				window.open('relatoriogeracontagemsetcolexcel.php?contagem='+contagem+'&coletor='+estoque+'&invdata='+invdata+'&setor='+contagem2, 'Report', 'status=yes, scrollbars=yes, location=no, toolbar=no, directories=no, resizable=no, fullscreen=yes');				
			}	
		}	
	}	
}
