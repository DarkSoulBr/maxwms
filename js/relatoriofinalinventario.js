...
function load_grid()
{
	...
	var i = 0; var grupo = "&grupo="; var auxcusto = "";
	...
	var custo1  = document.getElementById('custo1').checked;
	var custo2	= document.getElementById('custo2').checked;
	...
	window.open('relatoriogerafinalinventario.php?estoque='+estoque+grupo+subgrupo+'&nome='+nome+'&invdata='+invdata+'&custo='+auxcusto, 'Report', 'status=yes, scrollbars=yes, location=no, toolbar=no, directories=no, resizable=no, fullscreen=yes');
}
