...
function imprimirconsulta()
{
    ...
    if (erro == '0') {
        window.open('exportacaoprodutos.php?data=' + dataini + '&todos=' + todos + produto, '_blank');
    }
}
...
function load_grid_produtos()
{
    ...
    new ajax('cadastroconsultaprodutosgeral.php?nome=' + consultapro + '&opcao=' + opcaochecada, {onLoading: carregando, onComplete: imprime_produto});

    //window.open('cadastroconsultacligeral.php?consultacliente='+consultacli+'&opcao='+opcaochecada, '_blank');
