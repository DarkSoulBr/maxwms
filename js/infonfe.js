...
function imprime_serv(request){
	...
	if(cabecalho!=null)
	{
		...
		tabela+="<td colspan='1' class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><font color='#ffffff'><b>Chave</b></font></td>"
		tabela+="<td colspan='1' class='borda' bgcolor='#3366CC' bordercolor='#3366CC'><font color='#ffffff'><b>PIN</b></font></td>"					
...
function enviar(){
	...
	if(erro=='0'){
		...
		new ajax ('infonfeinsere.php?usucodigo='+ vusuario		
...
function apagar(codigo){
    new ajax ('infonfeapaga.php?codigo=' + codigo
        , {onLoading: carregando, onComplete: load_grid_serv});
}

function editar(codigo){

	new ajax ('infonfecarrega.php?parametro='+ codigo 
