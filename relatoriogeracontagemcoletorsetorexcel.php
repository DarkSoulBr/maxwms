...
$query = $cadastro->seleciona("colnome", "coletores", "colcodigo=$coletor");
$array = pg_fetch_object($query);

$estoque2 = $array->colnome;
...
//TITULO
echo "<td bgcolor='#CCCCCC' width='780' class='borda' colspan='12' align='center' valign='middle' height='35'><font color='#000000'><b>Relatório Gerencial de Contagem de Estoque</b>";
echo "<br>Contagem:</b> " . $estoque1 . " - Coletor: " . $estoque2 . "</font></td></tr>";
...
if ($row > 0) {
    ...
    //for($j=0;$j<100;$j++)
        ...
        if ($setor == '0' || $setor == 0) {
            $sql2 = "
				SELECT a.setor,sum(b.quantidade) as estoque 
				FROM setor a,inventariocontagemsetorproduto b where a.setcodigo = b.setcodigo and b.procodigo = " . $array_produto->procodigo . " and b.invdata = '$invdata' and b.concodigo = $contagem and b.colcodigo = $coletor group by a.setor,a.setcodigo order by a.setcodigo";
        } else {
            $sql2 = "
				SELECT a.setor,b.quantidade as estoque 
				FROM setor a,inventariocontagemsetorproduto b where a.setcodigo = b.setcodigo and b.procodigo = " . $array_produto->procodigo . " and b.invdata = '$invdata' and b.concodigo = $contagem and colcodigo = $coletor and b.setcodigo = $setor order by a.setcodigo";
        }
        ...
        if ($row2) {
            ...
            for ($j2 = 0; $j2 < $row2; $j2++) {
                $setorx = pg_fetch_result($sql2, $j2, "setor");
                ...
                if ($quantidade > 0) {
                    ...
                    echo "<td width=\"80\" align=\"left\" class='borda' bgcolor='#FFFFFF' bordercolor='#3366CC'><font color='#000000'><b>" . $setorx . "</b></font></td>";
