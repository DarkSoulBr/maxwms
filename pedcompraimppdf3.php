...
if ($row) {
    ...
    for ($i = 0; $i < $row; $i++) {
        ...
        //Sempre sim porque este pdf e chamado após atualizar o estoque
        $notatual = 'Sim';
  ...
  and a.procodigo = c.procodigo";
        ...
        if ($row) {
            ...
            for ($i = 0; $i < $row; $i++) {
                ...
                if (MAX_NOVO != 3) {
                    ...
                    $pdf->Cell(10, 4, $procod, 1, 0, 'L');
                    $pdf->Cell(90, 4, $prnome, 1, 0, 'L');
                    $pdf->Cell(7, 4, $proemb, 1, 0, 'R');
                    $pdf->Cell(10, 4, $temsortimento, 1, 0, 'L');
                    $pdf->Cell(22, 4, $proref, 1, 0, 'L');
                    ...
                    for ($j3 = 0; $j3 < $row3; $j3++) {
                        ...
                        if ($j3 == 0) {
                            ...
                            //Localiza as Quantidades que vieram do WMS
                            $quantidade = 0;
                            ...
                            if ($quantidade != 0 && $quantidade != $neisaldo) {
                                ...
                                $pdf->Cell(20, 4, $barunidade, 1, 0, 'L');
                                $pdf->Cell(13, 4, $clanumero, 1, 0, 'L');
                                $pdf->Cell(10, 4, $quantidade, 1, 0, 'R');
                        ...
                        $pdf->Cell(90, 4, $sortnom, 1, 0, 'L');
                        $pdf->Cell(7, 4, $sortemb, 1, 0, 'R');
                        $pdf->Cell(10, 4, $procod, 1, 0, 'L');
                        $pdf->Cell(22, 4, $sortref, 1, 0, 'L');
        ...
        $pdf->Cell(271, 4, 'Total Geral:   ' . $vtotalx, 1, 1, 'R');
