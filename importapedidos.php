...
<html>
    <head>
        ...
        <script src="js/importapedidos.js"></script>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
                                <tr>
                                    <td colspan="4" valign="middle" height="25">
                                        <div align="center"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><strong>Importação de Confirmação de Separação de Pedidos</strong></font></div>
                                    </td>
                                </tr>
                                <tr bgcolor="#CCCCCC">
                                    <td height="45">&nbsp;</td>
