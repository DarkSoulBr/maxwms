                ...
                if ($i != 4) {
                    if ($i == 0) {
                        if ($row->{$campos[4]} == 1) {
                            ...
                            $pdf->Cell(30, 4, '' . $row->{$campos[$i]} . ' ' . $row->{$campos[5]}, 0, 0, 'R');
                        } else {
                            $pdf->Cell(30, 4, '' . $row->{$campos[$i]} . ' ' . $row->{$campos[5]}, 0, 0, 'R');
                        }
                    } else if (($i > 0) and ( $i < 2)) {
                        $pdf->Cell(30, 4, '' . $row->{$campos[$i]}, 0, 0, 'R');
                    } else if ($i == 2) {
                        if ($row->{$campos[4]} == 2) {
                            $pdf->Cell(30, 4, '', 0, 0, 'R');
                            $pdf->Cell(30, 4, '' . $row->{$campos[$i]}, 0, 0, 'R');
                        ...
                        //rnum = deci(rnum);
                        $pdf->Cell(30, 4, '' . number_format($row->{$campos[$i]}, 2, ',', ''), 0, 0, 'R');
                    }
                } else if ($i == 4) {
                    if ($row->{$campos[4]} == 1) {
