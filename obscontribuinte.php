...
<script src="js/obscontribuinte.js"></script>
  ...
  <tr>
	<td>
		<table width="100%"  height="20" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
		  <tr>
			<td colspan="4" >
			<div align="center"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><strong>Observações de Interesse do Contribuinte</strong></font></div>
			</td>
		  </tr>
		</table>
          ...
          <table width="100%" height="80" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">            
			...
			<tr bgcolor="#CCCCCC">
				<td>&nbsp;</td>
				<td valign="middle"><div align="left">Observação:</div></td>
				<td colspan="2" valign="middle"><textarea name="obsgeral" id="obsgeral" cols="50" rows="2" onkeyup="this.value=this.value.toUpperCase()" onBlur="convertField(this);" ></textarea></td>
				<input name="hidden" type="hidden" id="codservico" value="">
			</tr>
			
			<tr bgcolor="#CCCCCC">
				<td>&nbsp;</td>
				<td valign="middle"><div align="left">Identificador:</div></td>
				<td colspan="2" valign="middle"><input type="text" name="servico" id="servico" maxlength="30" size="18" onkeyup="this.value=this.value.toUpperCase()" onBlur="convertField(this);">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="incluir" id="incluir" value="Incluir" onclick="enviar();"></td>				
			</tr>
