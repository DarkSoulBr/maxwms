...
require_once("include/relatoriosobraantigoinventario.php");
...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(80);
        //Title
        $this->Cell(30, 5, 'Relatório de Sobra de Inventário', 0, 1, 'C');
    ...
    for ($i = 0; $i < $contagrupo; $i++) {
        ...
        if ($row > 0) {
            for ($j = 0; $j < $row; $j++) {
                ...
                $sobra = $array_produto->atual - $array_produto->antigo;
