...
<html>
    <head>
        ...
        <!-- Title Page-->
        <title>Relatório de Contagem de Estoque (Comparação)</title>        
    ...
    <body onload="dadospesquisadata(0);">
            ...
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-header">
                        Relatório de Contagem de Estoque (Comparação)
                    </div>
                    <div class="card-body">                    
                        <form method="POST"> 
        ...
        <div id="resultado">
            ...
            <script src="js/relatoriogeracontagemcompara.js"></script>
