...
<html>
    <head>
        ...
        <!-- Title Page-->
        <title>Cadastro de Tipo de Servico</title> 
    ...
    <body> 
                                        ...
                                        <div>                                          
                                            <span class="custom-dropdown">
                                                <select name="listDados" onChange="dadospesquisa2(this.value);">
                                                    <option id="opcoes" value="0">Faça a Pesquisa de Tipo de Serviço</option>                                                
                                                </select> 
                                            </span>
                                        </div>
                                    </div>
									<input id="sercodigo" type="hidden" name="sercodigo" size="25">
                                </div>                                
                            </div>
                            <div class="row row-space">
                                <div class="col-1">
                                    <div class="input-group">
                                        <label class="label">Tipo de Serviço</label>
                                        <div class="input-group-icon">
                                            <input class="input--style-4" id="sernome" type="text" name="sernome" size="45" maxlength="40" onBlur="convertField(this)">
                                        </div>
                                    </div>
                                </div>                                
                            </div>
		...
		<script src="js/tiposervico.js"></script>
