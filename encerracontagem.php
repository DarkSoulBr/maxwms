...
<html>
    <head>
        ...
        <!-- Title Page-->
        <title>Encerramento de Contagem de Estoque</title>        
    ...
    <body onload="dadospesquisadata(0);">
            ...
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-header">
                        Encerramento de Contagem de Estoque
                    </div>
                    <div class="card-body">                    
                        <form method="POST"> 
                            ...
                            <div class="p-t-15 centraliza">
                                <button class="btn btn--radius-2 btn--blue" type="button" id="botao" onclick="imprelatorioexexcel();">Encerra</button>
                            </div>								
                        </form>
                    </div>
                </div>                
        ...
        <div id="resultado">
            ...
            <script src="js/encerracontagem.js"></script>
