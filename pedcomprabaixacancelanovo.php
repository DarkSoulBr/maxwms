...
<html>
    ...
    <body onLoad="ver(0, 0, 0, 0)";>
            ...
            <div class="wrapper wrapper--w780">
                <div class="card card-4">
                    <div class="card-header">
                        Cancela Baixa de Pedidos de Compra
                    </div>
                    <div class="card-body">                    
                        <form name="formulario" method="POST">
                            ...
                            <div class="row row-space">
                                <div class="col-2 centraliza">
                                    <button class="btn-medium btn--radius-2 btn--blue" type="button" id="button" onClick="cancelar()" disabled>Cancelar Baixa</button>                                    
                                </div>
                                <div class="col-2 centraliza">
        ...
        <script src="js/pedcomprabaixacancelanovo.js"></script>        
