                    ...
                    <tr>
                        <td colspan="5">
                            <div align="center"><font color="#FFFFFF"
                                                      face="Verdana, Arial, Helvetica, sans-serif"><strong>Administação de Pedido</strong></font></div>
                        </td>
                    </tr>
                </table>
                        ...
                        <table width="100%" border="0" cellpadding="0"
                            ...
                            <tr>
                                <td colspan="5" align="center">
                                    <input id="btnConsultaPedidos" type="button" name="btnConsultaPedidos" size="10" value="LOCALIZAR"></td>
