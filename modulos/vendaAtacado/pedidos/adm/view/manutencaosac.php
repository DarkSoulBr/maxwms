                    ...
                    <tr>
                        <td valign="middle" height="25">
                            <div align="center"><font color="#FFFFFF"
                                                      face="Verdana, Arial, Helvetica, sans-serif"> <strong>SAC - INCLUSÃO DE CHAMADOS</strong> </font></div>
                        </td>
                    </tr>
...
<!--					<tr bgcolor="#CCCCCC">
                                ...
                                <tr bgcolor="#CCCCCC">
                                    <td height="17" colspan="4"><!-- incluir componente de pesquisa de clientes -->
                                        <?php include_once("pesquisaClientesSac.php"); ?>
                            ...
                            <table width="100%" height="599" border="0" cellpadding="2"
                                ...
                                <tr>
                                    <td width="100%">
                                        <form name="formManutencaoSac" id="formManutencaoSac">
