...
Class EstacionamentoModel {
    ...
    /**
     * Metodo para localizar verificar a senha digitada para liberar pedido bloqueado devido a validação cidade IBGE divergente da cidade Faturamento
     * ver config.php lista de tabelas.
     *
     * @access public
     * @param PedidoVO $valor Recebe variavel do tipo Pedido Value Object.
