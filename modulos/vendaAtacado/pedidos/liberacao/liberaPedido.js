			...
			if(pedido.tipoPedido.sigla=='R'){
				...
				//limiteDisponivel = pedido.cliente.clilimite - pedido.cliente.vendasEmAberto.totalVendas;
                           ...
                           $.each(pedido.preFechamento, function (key, valueX) {
                                                if (valueX.fecforma != '100' && valueX.fecforma != '102' && valueX.fecforma != '105') {
                                                        valorPreFechamentoAtual += Number(valueX.fecvalor);
//alert ("valueX.fecvalor: " + valueX.fecvalor
//+"\n valorPreFechamentoAtual: "+valorPreFechamentoAtual
//);
...
// utilizado para permitir que compras com vale, a vista e cartão não sejam bloqueadas e possam ser usadas para pagar diferença.
...
//alert ("limiteDisponivel: "+limiteDisponivel+
//"\n Number(pedido.cliente.clilimite): "+Number(pedido.cliente.clilimite)+
//"\n Number(pedido.cliente.vendasEmAberto.totalVendas): "+Number(pedido.cliente.vendasEmAberto.totalVendas)+
//"\n Number(totalValorPreFechamento: "+Number(totalValorPreFechamento ));

                                if(pedido.cliente.clidatavalida == undefined || pedido.cliente.clidatavalida == '' || pedido.cliente.clidatavalida == '0')
				{
					msg = "<br> - DADOS CADASTRAIS DO CLIENTE NÃO ENCONTRAM-SE VALIDADOS - SERÁ ENCAMINHADO AO FINANCEIRO";
//					msg += "<br> - DADOS CADASTRAIS DO CLIENTE NÃO ENCONTRAM-SE VALIDADOS - SERÁ ENCAMINHADO AO FINANCEIRO";
//					alert('DADOS CADASTRAIS DO CLIENTE NÃO ENCONTRAM-SE VALIDADOS - SERÁ ENCAMINHADO AO FINANCEIRO');
					$("#retorno").messageBox(msg,false, false);
					msgPreFec ="DADOS CADASTRAIS DO CLIENTE NÃO ENCONTRAM-SE VALIDADOS - SERÁ ENCAMINHADO AO FINANCEIRO";
//					msgPreFec +="DADOS CADASTRAIS DO CLIENTE NÃO ENCONTRAM-SE VALIDADOS - SERÁ ENCAMINHADO AO FINANCEIRO";
					return false;
				}
				...
				{
					msg = "<br> - DADOS CADASTRAIS DO CLIENTE ENCONTRAM-SE DESATUALIZADOS - SERÁ ENCAMINHADO AO FINANCEIRO";
//					msg += "<br> - DADOS CADASTRAIS DO CLIENTE NÃO ENCONTRAM-SE VALIDADOS - SERÁ ENCAMINHADO AO FINANCEIRO";
//					alert('DADOS CADASTRAIS DO CLIENTE NÃO ENCONTRAM-SE VALIDADOS - SERÁ ENCAMINHADO AO FINANCEIRO');
					$("#retorno").messageBox(msg,false, false);
					msgPreFec ="DADOS CADASTRAIS DO CLIENTE ENCONTRAM-SE DESATUALIZADOS - SERÁ ENCAMINHADO AO FINANCEIRO";
//					msgPreFec +="DADOS CADASTRAIS DO CLIENTE NÃO ENCONTRAM-SE VALIDADOS - SERÁ ENCAMINHADO AO FINANCEIRO";
					return false;
				}
...
//				if((pedido.cliente.clilimite < pedido.cliente.vendasEmAberto.totalVendas) && value.fecforma=='101')
				if((limiteDisponivel <= 0) && value.fecforma=='101')
				{
                                        ...
                                        if(limiteDisponivel <= 0 ||limiteMostrar <= 0) {
                                           ...
                                           msg = "<br /> - DISPONÍVEL O LIMITE DE "+ limiteMostrar +" PARA PAGAMENTO EM DUPLICATA. O RESTANTE PODE SER PAGO A VISTA OU COM CARTAO.";
                                        }
...
//				if((limiteDisponivel <= 0) && (value.fecforma=='103' || value.fecforma=='110'))
				{
                                    if(limiteDisponivel <= 0 ||limiteMostrar <= 0) {
                                     ...
                                     msg = "<br /> - DISPONÍVEL O LIMITE DE "+ limiteMostrar +" PARA PAGAMENTO EM CHEQUE. O RESTANTE PODE SER PAGO A VISTA OU COM CARTAO.";
                                }
