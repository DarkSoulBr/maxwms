...
<html>
    <head>
        ...
        <!-- Title Page-->
        <title>Finaliza Contagem - Transfere dados Inventário</title>        
    ...
    <body onload="dadospesquisadata(0);">
            ...
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-header">
                        Finaliza Contagem - Transfere dados Inventário
                    </div>
                    <div class="card-body">                    
                        <form method="POST"> 
                            ...
                            <div class="row row-space ">                                
                                <div class="col-2">
                                    <div class="input-group">
                                        <label class="label">Inventário</label>
                                        <div class="input-group-icon">
                                            <input class="input--style-4" name="pvemissao2" type="text" id="pvemissao2" OnKeyPress="formatar('##/##/####', this)" onBlur="formata_data2(this, this.value)" maxlength="10" size="10">
                                        </div>
                                    </div>
                                </div>                                                           
                            </div>	               		
                            ...
                            <div class="p-t-15 centraliza">
                                <button class="btn btn--radius-2 btn--blue" type="button" id="botao" onclick="imprelatorioexexcel();">Finaliza</button>
                            </div>								
                        </form>
                    </div>
                </div>                
        ...
        <div id="resultado">
            ...
            <script src="js/finalizacontagem.js"></script>
