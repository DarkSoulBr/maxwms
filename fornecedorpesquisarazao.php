...
* a partir da Razao Social e retorna um XML com o código Interno do Fornecedor
*
* @name Fornecedor Search
* @link fornecedorpesquisarazao.php
* @version 50.3.6
* @since 1.0.0
* @author Luis Ramires <delta.mais@uol.com.br>
* @copyright MaxTrade
*
* @global string $_POST['parametro'] Razão Social do Fornecedor 
*/
