...
class EnviaEmail {
    ...
    public function envia($destinatario, $assunto, $msg, $bcc = "") {
        ...
        //$config = array('auth' => 'login', 'username' => 'sac.workflow@baraodistribuidor.com.br', 'password' => 'centro01' , 'port'=>'587');
        //$tr = new Zend_Mail_Transport_Smtp('smtp.baraodistribuidor.com.br', $config);		
        //$config = array ("auth"=>"login", "username"=>"deltamais@uol.com.br", "password"=>"xxxxxxxx" , "port"=>"587");
        //$tr = new Zend_Mail_Transport_Smtp ('smtp.uol.com.br', $config);		
        ...
        //$mail->setFrom("sac.workflow@baraodistribuidor.com.br", "Workflow MAXTrade");
        //$mail->setFrom("deltamais@uol.com.br", "Workflow MAXTrade");
    ...
    public function enviaAnexo($destinatario, $assunto, $msg, $anexo) {
        ...
        $mail->addBcc('andre.mor@baraodistribuidor.com.br');
