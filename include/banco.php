...
class banco {
    ...
    function insere($tabela, $campos, $valores) {
        //echo "INSERT INTO $tabela $campos VALUES $valores" . '<hr>';
        $this->query = "INSERT INTO $tabela $campos VALUES $valores";
        pg_query($this->query) or die("Nao foi possivel inserir o registro na base: " . $this->query);
    }
    ...
    function apaga($tabela, $condicao) {
        ...
        pg_query($this->query) or die("Nao foi possivel apagar o registro na base " . $this->query);
    }
