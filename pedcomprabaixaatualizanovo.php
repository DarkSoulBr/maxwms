...
<html>
    <head>
        ...
        <!-- Title Page-->
        <title>Atualização de Estoque das Baixas de Pedidos de Compra</title>
    ...
    <body onLoad="ver(0, 0, 0, 0)";>
            ...
            <div class="wrapper wrapper--w780">
                <div class="card card-4">
                    <div class="card-header">
                        Atualização de Estoque das Baixas de Pedidos de Compra
                    </div>
                    <div class="card-body">                    
                        <form name="formulario" method="POST">
                            ...
                            <div class="row row-space">
                                <div class="col-4">
                                    <div class="input-group-small m-r-45">
                                        ...
                                        <div class="input-group-small-icon">
                                            <input class="input--style-4" name="pcnumero" type="text" id="pcnumero" onKeyPress="maiusculo()" size="10"  style="BACKGROUND-COLOR: #b3c6ff; COLOR: #660000; FONT-WEIGHT: bold;">
                                ...
                                <div class="col-4 centraliza">
                                    <div class="input-group-small m-r-45">
                                        ...
                                        <button class="btn-small btn--radius-2 btn--blue" name="button_baixas" type="button" id="button_baixas" onClick="ver3()";>Baixas</button>                                        
                                    </div>
                                </div>      
                                    ...
                                    <div class="input-group-small m-r-45">
                                        ...
                                        <div class="input-group-small-icon">
                                            <span class="custom-dropdown">
                                                <select name="listsec">
                                                    <option id="opcoes" value="0">__</option>
                                                </select> 
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-4 centraliza">
                                    <div class="input-group-small m-r-45">
                                        <label class="label">&nbsp;</label>
                                        <button class="btn-small btn--radius-2 btn--blue" name="button_pesquisa" type="button" id="button_pesquisa" onClick="ver()"; disabled>Pesquisar</button>
                            ...
                            <div class="row row-space">
                                <div class="col-2 centraliza">
                                    <button class="btn-medium btn--radius-2 btn--blue" type="button" id="button" onClick="cancelar()" disabled>Atualizar Estoque</button>                                    
                                </div>
                                <div class="col-2 centraliza">
                            ...
                            <div style ="display:none">
                                <input id="deposito" type="hidden" name="deposito" size="25">
        ...
        <script src="js/pedcomprabaixaatualizanovo.js"></script>        
