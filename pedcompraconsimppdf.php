            ...
            foreach ($read3->getResult() as $registros3) {
                ...
                if ($pcisaldo > 0) {
                    ...
                    if (MAX_NOVO != 3) {
                        ...
                        $sql4 = "SELECT a.procodigo as sortcodigo,a.procod as sortcod,a.prnome as sortnom,a.proref as sortref,a.proemb as sortemb,d.medsigla as sortmed FROM produto a 
