...
$sql = "select a.segcodigo,b.resnome,a.segnome,a.segvalor,a.segapolice,a.segaverbacao from infoseguro a,tiporesponsavel b 
where a.rescodigo=b.rescodigo and a.usucodigo=$usucodigo order by a.segcodigo";
...
if ($row) {
    ...
    for ($i = 0; $i < $row; $i++) {
        ...
        $medida = pg_fetch_result($sql, $i, "resnome");
