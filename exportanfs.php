...
<html>
    <head>
        ...
        <script src="js/exportanfs.js"></script>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
                                <tr>
                                    <td colspan="4" valign="middle" height="25">
                                        <div align="center"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><strong>Exportação de Notas de Saida</strong></font></div>
                                    </td>
                                </tr>
                                <tr bgcolor="#CCCCCC">
                                    <td height="45">&nbsp;</td>
                                ...
                                <tr bgcolor="#CCCCCC" style="display:none;" id="lin7">
                                    ...
                                    <td valign="middle"><div align="left"><b>/home/teltex/nfs.csv</b></div></td>
                                    <td>&nbsp;</td>
                                </tr> 
                                ...
                                <tr bgcolor="#CCCCCC" style="display:none;" id="lin8">
                                    <td colspan="8">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr bgcolor="#CCCCCC">
                                                <td valign="middle" colspan="8">&nbsp;<b>Notas:</b></td>
                                            </tr>
                                            ...
                                            <tr bgcolor="#CCCCCC">
                                                <td valign="middle" colspan="8">&nbsp;&nbsp;&nbsp;Opção:
                                                    <input type="radio" name="opcaop" id="opcaop1" value="1" align="absmiddle" checked> Nota &nbsp;<input type="radio" name="opcaop" id="opcaop2" value="2" align="absmiddle"> Pedido </td>
                                            </tr>
                                ...
                                <tr bgcolor="#CCCCCC" style="display:none;" id="lin9">
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">					
                                            ...
                                            <tr bgcolor="#CCCCCC">
                                                <td height="50">&nbsp;</td>
                                                <td valign="middle" colspan="2" align="center"><b>Selecione a(s) Nota(s):</b>
