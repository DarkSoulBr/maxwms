...
<html>
    <head>
        ...
        <!-- Title Page-->
        <title>Relatório de Resultado de Inventário</title>        
    ...
    <body onload="load_grupo();load_subgrupo();load_grid_estoque();datadiacampo('datainventario');">
                            ...
                            <div class="row row-space">
                                <div class="col-1">
                                    <div class="input-group m-r-45">
                                        ...
                                        <div>
                                            <label class="radio-container m-r-15">Real                     
                                                <input type="radio" name="custo" id="custo1" value="1">
                                                <span class="checkmark"></span>
                                            </label>
                                            <label class="radio-container m-r-15">Final
                                                <input type="radio" name="custo" id="custo2" value="1">
                                                <span class="checkmark"></span>
                                            </label>								
                                        </div>
                                    </div>
        ...
        <script src="js/relatoriofinalinventario.js"></script>
