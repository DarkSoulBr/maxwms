...
if ($parametro2 == "1") {
    $sql = "
       SELECT a.tracodigo,a.tranguerra,a.trarazao,a.tracep,a.traendereco,
       a.trabairro,a.trafone,a.trafax,a.traemail,a.traobs,a.cidcodigo,
       b.descricao,b.uf,a.rotcodigo,a.tpfcodigo,a.tracnpj,a.traie,
       a.doccobvers,
       a.ocorenvers,
       a.conembvers,
	   a.notfisvers,
       ...
       WHERE a.tranguerra like '%$parametro%'
