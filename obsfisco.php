...
<script src="js/obsfisco.js"></script>
  ...
  <tr>
	<td>
		<table width="100%"  height="20" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
		  <tr>
			<td colspan="4" >
			<div align="center"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><strong>Observações de Interesse do Fisco</strong></font></div>
			</td>
		  </tr>
		</table>
