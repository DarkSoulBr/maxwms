...
<html>
    <head>
        ...
        <!-- Title Page-->
        <title>Pedidos Baixados de Compras por Fornecedor</title>        
    ...
    <body onload="datadiacampo('datainiform', 'datafimform');">
            ...
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-header">
                        Pedidos Baixados de Compras por Fornecedor
                    </div>
                    <div class="card-body">                    
                        <form method="POST"> 
                                ...
                                <div class="col-2">
                                    <div class="input-group m-r-45">
                                        ...
                                        <div class="input-group-icon">
                                            <input class="input--style-4" type="text" name="datainiform" id="datainiform" OnKeyPress="formatar('##/##/####', this)" onBlur="dataano(this, this.value)" maxlength="10" size="12">
                                        </div>
                                    </div>
                                </div>                                             
                                <div class="col-2">
                                    <div class="input-group m-r-45">
                                        ...
                                        <div class="input-group-icon">
                                            <input class="input--style-4" type="text" name="datafimform" id="datafimform" OnKeyPress="formatar('##/##/####', this)" onBlur="dataano(this, this.value)" maxlength="10" size="12">
                                        </div>
                                    </div>
                                </div>                        
                            </div>
                                ...
                                <div class="col-3">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-icon centraliza">
                                            <button class="btn-small btn--radius-2 btn--blue" type="button" name="pesquisar" id="pesquisar" value="Pesquisar" onclick="load_gridfor();" disabled>Pesquisar</button>
                                        </div>
                                    </div>                                    
                                </div>
                            </div>
                            ...
                            <div class="p-t-15 centraliza">
                                <button class="btn btn--radius-2 btn--blue" type="button" id="botao" onclick="imprimirconsultapedbaicomfornecedor();">Consultar</button>
                            </div> 				
                        </form>
                    </div>
                </div>                
        ...
        <div id="msgfor" style="visibility: hidden;">
            ...
            <script src="js/consultapedbaicomfornecedor.js"></script>
