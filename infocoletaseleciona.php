...
$sql = "select colcodigo,colserie,colnumero,colemissao,colcnpj,colie,coluf,colfone,colinterno from infocoleta a 
where usucodigo=$usucodigo order by colcodigo";
