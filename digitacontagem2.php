...
<html>
    <head>
        ...
        <script src="js/digitacontagem2.js"></script>
    ...
    <style>
        ...
        div{font-family: Verdana; font-size: 30px;}
        td{font-family:Verdana ; font-size: 30px;}
        input{font-family:Verdana ; font-size: 30px;}
        select{font-family:Verdana ; font-size: 30px;}
        .style3 {color: #000000}
    </style>
    ...
    <center>
        <div>
            ...
            <form name="formulario">
                <table width="960" height="274" border="2" cellspacing="0" cellpadding="0" bordercolor="#999999">
                    <tr>
                        <td width="956" height="270">
