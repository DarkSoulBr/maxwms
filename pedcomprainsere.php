<?php
/**
* Inclusao de Pedidos de Compras
*
* Programa que faz a inclusao dos Pedidos de Compra na Base de Dados e retorna
* um XML com o número do pedido gerado
*
* @name Compra Insert
* @link pedcomprainsere.php
* @version 50.3.6
* @since 1.0.0
...
$cadastro->insere("pcompra", "(pcnumero,pcentrega,pcemissao,pcchegada,forcodigo,comprador,pcprocesso,comissao,condicao,
observacao1,observacao2,observacao3,observacao4,observacao5,perdesconto,desconto,tipo,localentrega,tipoped,total
,tipoparcelas,parcelas,
parcdia1,parcdia2,parcdia3,parcdia4,parcdia5,parcdia6,
parcdata1,parcdata2,parcdata3,parcdata4,parcdata5,parcdata6,
parcela1,parcela2,parcela3,parcela4,parcela5,parcela6,pvnumero,ipi,serie,pccontainers
)", "('$pcnumero','$pcentrega','$pcemissao',$pcchegada,'$codigofornecedor','$comprador','$pcprocesso','$comissao','$condicao',
'$observacao1','$observacao2','$observacao3','$observacao4','$observacao5','$percdesc','$pcdesconto','$radio','$radioa','$radiob','$total'
,'$tipoparcelas','$parcelas',
'$parcdia1','$parcdia2','$parcdia3','$parcdia4','$parcdia5','$parcdia6',
'$parcdata1','$parcdata2','$parcdata3','$parcdata4','$parcdata5','$parcdata6',
'$parcela1','$parcela2','$parcela3','$parcela4','$parcela5','$parcela6','$pvnumero','$ipi',1,'$pccontainer'
)");
...
if (sizeof($campo1) > 0) {
    for ($i = 0; $i < sizeof($campo1); $i++) {
        ...
        if (trim($campo1[$i]) != '0') {
			...
			)", "('$pcnumero','$j','$procodigo','$quantidade','$custo','$desc1','$desc2','$desc3',$desc4,$ipi,'$entrega'
			)");
            }
        }
    }
