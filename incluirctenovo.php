...
<script src="js/incluirctenovo.js"></script>
...
<body onload="load_pedido('<?php echo $usuario ?>');">
...
<table width="1000" height="230" border="0" cellspacing="0" cellpadding="0" bordercolor="#999999">
    ...
    <div>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
		  		<tr>
					<td valign="middle" height="25"><div align="center"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><strong>Conhecimento de Transporte Eletrônico - Inclusão</strong></font></div></td>
		  		</tr>
		  		<tr bgcolor="#CCCCCC">
		  			<td valign="top" width="100%">
		  				<table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								<td width="23">&nbsp;</td>
               					<td width="100"><input type="text" name="orcnumero" id="orcnumero" maxlength="10" size="10" readonly></td>
			  ...
			  <tr bgcolor="#CCCCCC">
                <td colspan="6"> <Center>
                	<input type="button" id="botaoinc" value="Incluir" onclick="incluirorcamento(1);"> 
					&nbsp;&nbsp;&nbsp;	

					<input type="button" id="botaonfe" value="NFe" onclick="importarnfe(orcnumero.value,<?php echo $usuario ?>);"> 
					&nbsp;&nbsp;&nbsp;
    ...
    <div>	
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
			  ...
			  <tr bgcolor="#CCCCCC">
                <td colspan="6"> <Center>
                	<input type="button" id="botaoinc" value="Incluir" onclick="incluirorcamento(2);"> 
					&nbsp;&nbsp;&nbsp;					
    ...
    <div>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
			  ...
			  <tr bgcolor="#CCCCCC">
                <td colspan="6"> <Center>
                	<input type="button" id="botaoinc" value="Incluir" onclick="incluirorcamento(3);"> 
					&nbsp;&nbsp;&nbsp;				
    ...
    <div>		
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
			  ...
			  <tr bgcolor="#CCCCCC">
                <td colspan="6"> <Center>
                	<input type="button" id="botaoinc" value="Incluir" onclick="incluirorcamento(4);"> 
					&nbsp;&nbsp;&nbsp;					
    ...
    <div>		
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
			  ...
			  <tr bgcolor="#CCCCCC">
                <td colspan="6"> <Center>
                	<input type="button" id="botaoinc" value="Incluir" onclick="incluirorcamento(5);"> 
					&nbsp;&nbsp;&nbsp;		
    ...
    <div>		
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
			  ...
			  <tr bgcolor="#CCCCCC">
                <td colspan="6"> <Center>
                	<input type="button" id="botaoinc" value="Incluir" onclick="incluirorcamento(6);"> 
					&nbsp;&nbsp;&nbsp;	
