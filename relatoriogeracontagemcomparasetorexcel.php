...
//TITULO
echo "<td bgcolor='#CCCCCC' width='780' class='borda' colspan='13' align='center' valign='middle' height='35'><font color='#000000'><b>Relatório Gerencial de Contagem de Estoque</b>";
...
if ($row > 0) {
    ...
    //for($j=0;$j<100;$j++)
        ...
        if ($j == 0) {
            ...
            echo "<td align=\"left\" class='borda' bgcolor='#CCCCCC' bordercolor='#3366CC'><font color='#000000'><b>Diferença</b></font></td>";
