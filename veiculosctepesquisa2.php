...
veipropveiculo,veiuf,veitpdoc,veicpf,veicnpj,veirntrc,veiie,veipropuf,veitpproprietario,veirazao,veipessoa,veirg,veiempresa 
    FROM veiculoscte WHERE veicodigo = '$parametro'	        
	ORDER BY veicodigo";
