...
$sql = "SELECT
  ...
  c.notentvaloripi,c.notentobservacoes,c.notentcodigo,c.notentserie,c.notatualiza
...
if ($row) {
    ...
    for ($i = 0; $i < $row; $i++) {
        ...
        //Verifica se é um pedido de Cross
        $pedidocross = 0;
        $xml .= "<dado>\n";
        ...
        $xml .= "<pedidocross>" . $pedidocross . "</pedidocross>\n";
