...
if ($parametro == '') {
    ...
    if ($parametro2 == "1") {
        $sql = $sql . " WHERE a.motcod = '$parametro' ORDER BY a.motcod";
    } elseif ($parametro2 == "3") {
        $sql = $sql . " WHERE a.motrazao like '%$parametro%' ORDER BY a.motrazao";
    } else {
        $sql = $sql . " WHERE a.motcpf like '%$parametro%' ORDER BY a.motcpf";
    }
}
