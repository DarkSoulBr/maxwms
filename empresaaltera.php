...
$cadastro -> altera ( "empresa" , "clinguerra='$fornguerra',clicod='$forcod',clirazao='$forrazao',clicnpj='$forcnpj',cliie='$forie',clirg='$forrg',clicpf='$forcpf',cliobs='$forobs',clipessoa='$forpessoa',clisuframa='$forsuframa',clialt='$atual',clicep='$fnecep',cliendereco='$fneendereco',clibairro='$fnebairro',clifone='$fnefone',clicomplemento='$fnecomplemento',cliemail='$fneemail',cidcodigo='$fnecodcidade',cidcodigoibge='$cidadeibge',clinumero='$fnenumero'" , "empcodigo=$forcodigo" );
