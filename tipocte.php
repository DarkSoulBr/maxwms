...
<html>
    <head>
        ...
        <!-- Title Page-->
        <title>Cadastro de Finalidade de Emissao</title> 
    ...
    <body> 
            ...
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-header">
                        Cadastro de Finalidade de Emissao
                    </div>
                    <div class="card-body">                    
                        <form method="POST">
                                        ...
                                        <div>                                          
                                            <span class="custom-dropdown">
                                                <select name="listDados" onChange="dadospesquisa2(this.value);">
                                                    <option id="opcoes" value="0">Faça a Pesquisa de Finalidade</option>                                                
                                                </select> 
                                            </span>
                                        </div>
                                    </div>
									<input id="tctcodigo" type="hidden" name="tctcodigo" size="25">
                                </div>                                
                            </div>
                            <div class="row row-space">
                                <div class="col-1">
                                    <div class="input-group">
                                        <label class="label">Finalidade</label>
                                        <div class="input-group-icon">
                                            <input class="input--style-4" id="tctnome" type="text" name="tctnome" size="45" maxlength="40" onBlur="convertField(this)">
                                        </div>
                                    </div>
                                </div>                                
                            </div>
		...
		<script src="js/tipocte.js"></script>
