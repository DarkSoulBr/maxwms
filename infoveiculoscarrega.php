...
$sql = "SELECT infveicodigo,veicod,veirenavam,veiplaca,veitara,veicapacidadekg,veicapacidadem3,veitprodado,veitpcarroceria,veitpveiculo,
veipropveiculo,veiuf,veitpdoc,veicpf,veicnpj,veirntrc,veiie,veipropuf,veitpproprietario,veirazao,veipessoa,veirg,veiempresa FROM infoveiculos where infveicodigo=$codigo";
