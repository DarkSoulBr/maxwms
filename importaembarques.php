...
<html>
    <head>
        ...
        <script src="js/importaembarques.js"></script>
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#3366CC">
                                ...
                                <tr bgcolor="#CCCCCC" style="display:none;" id="lin7">
                                    ...
                                    <td valign="middle"><div align="left"><b>/home/teltex/pedido.csv</b></div></td>
                                    <td>&nbsp;</td>
                                </tr> 
                                ...
                                <tr bgcolor="#CCCCCC" style="display:none;" id="lin8">
                                    <td colspan="8">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr bgcolor="#CCCCCC">
                                                <td valign="middle" colspan="8">&nbsp;<b>Pedidos:</b></td>
                                            </tr>
                                            ...
                                            <tr bgcolor="#CCCCCC">
                                                <td valign="middle" colspan="8">&nbsp;&nbsp;&nbsp;Opção:
                                                    <input type="radio" name="opcaop" id="opcaop1" value="1" align="absmiddle" checked> Pedido &nbsp;<input type="radio" name="opcaop" id="opcaop2" value="2" align="absmiddle"> Nome </td>
                                            </tr>
                                ...
                                <tr bgcolor="#CCCCCC" style="display:none;" id="lin9">
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">					
                                            ...
                                            <tr bgcolor="#CCCCCC">
                                                <td height="50">&nbsp;</td>
                                                <td valign="middle" colspan="2" align="center"><b>Selecione o(s) Pedidos(s):</b>
                                    ...
                                    <td valign="bottom" align="center"><b>Pedidos Selecionados:</b>
