...
<html>
    ...
    <body> 
                                        ...
                                        <div>                                          
                                            <span class="custom-dropdown">
                                                <select name="listDados" onChange="dadospesquisa2(this.value);">
                                                    <option id="opcoes" value="0">Faça a Pesquisa de Forma De Pagamento</option>                                                
                                                </select> 
                                            </span>
                                        </div>
                                    </div>
									<input id="tpgcodigo" type="hidden" name="tpgcodigo" size="25">
                                </div>                                
                            </div>
                            <div class="row row-space">
                                <div class="col-1">
                                    <div class="input-group">
                                        <label class="label">Forma de Pagamento</label>
                                        <div class="input-group-icon">
                                            <input class="input--style-4" id="tpgnome" type="text" name="tpgnome" size="45" maxlength="40" onBlur="convertField(this)">
                                        </div>
                                    </div>
                                </div>                                
                            </div>
		...
		<script src="js/tipopagamento.js"></script>
